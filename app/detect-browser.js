...
import { buildRules, versionNumber } from './utilities.js';
...
function parseUserAgent(userAgentString) {
  ...
  const query = /alexa|bot|crawl(er|ing)|facebookexternalhit|feedburner|google web preview|nagios|postrank|pingdom|slurp|spider|yahoo!|yandex/i;
...
export default function detect(userAgentString) {
