	...
	return {
		...
		init: function init(userAgentString) {
			...
			if (typeof userAgentString === 'string') {
				browserInfo = (0, _detectBrowser.detect)(userAgentString);
			}
		...
		is: function is(rules, callback) {
			...
			rules.forEach(function (rule) {
				...
				if (condition.name === browserInfo.name && !(0, _utilities.operator)(browserInfo.version, condition.version, condition.operation)) {
					valid = false;
				}
